  ...
  return (
    <div className="flex h-full">
                ...
                <li className="mb-2">
                  <details open>
                    ...
                    <ul>
                      {profileData && (
                        ...
                        >
                          <div
                            onClick={() => {
                              navigateToPage(
                                `/manageprofiledoctors/${profileData.profile_id}/edit`
                              );
                      ...
                      <li
                        className={`mb-2 ${
                          activeMenu === "registerpatients" ? "active" : ""
                        }`}
                      >
                        <div
                          onClick={() => {
                            navigateToPage("registerpatients");
                            setActiveMenu("registerpatients");
                          }}
                          className="hover:text-indigo-400"
                        >
                          <svg
                      ...
                      <li
                        className={`mb-2 ${
                          activeMenu === "patientlist" ? "active" : ""
                        }`}
                      >
                        <div
                          onClick={() => {
                            navigateToPage("patientlist");
                            setActiveMenu("patientlist");
                          }}
                          className="hover:text-indigo-400"
                        >
                          <svg
                ...
                <li className="mb-2">
                  <details open>
                    ...
                    <ul>
                      <li
                        className={`mb-2 ${
                          activeMenu === "imageprediction" ? "active" : ""
                        }`}
                      >
                        <div
                          onClick={() => {
                            navigateToPage("imageprediction");
                            setActiveMenu("imageprediction");
                          }}
                          className="hover:text-indigo-400"
                        >
                          <svg
                      ...
                      <li
                        className={`mb-2 ${
                          activeMenu === "doctorsreportanalysis" ? "active" : ""
                        }`}
                      >
                        <div
                          onClick={() => {
                            navigateToPage("doctorsreportanalysis");
                            setActiveMenu("doctorsreportanalysis");
                          }}
                          className="hover:text-indigo-400"
                        >
                          <svg
                            ...
                            width="24px"
                            fill={
                              activeMenu === "doctorsreportanalysis"
                                ? "#4A00FF"
                                : "#ffffff"
                            }
                          >
      ...
      <div className={`flex-grow ${isSidebarOpen ? "ml-64" : ""} duration-300`}>
        ...
        <div
          className="flex-1 h-full overflow-auto p-4 mt-16"
