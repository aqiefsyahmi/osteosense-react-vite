...
const DoctorsReportAnalysis = () => {
  ...
  // const [doctorInfo, setDoctorInfo] = useState([]); //for declare  doctor data
  ...
  const getDoctorAndPredict = async () => {
    try {
      const response = await axios.get(
        `http://127.0.0.1:5000/doctor_with_predictions/${idtoken}`,
        {
          headers: {
      ...
      // setDoctorInfo(response.data.doctor); //for set doctor data
      setPredictList(response.data.predictions);
    } catch (error) {
          ...
          <div className="flex justify-end items-center gap-3">
            <div>
              ...
              <ItemsPerPageDropdown
                value={itemsPerPage}
                options={["6", "15", "20", "25", predictlist.length]}
